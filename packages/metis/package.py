...
class Metis(CMakePackage):
    ...
    url = "https://github.com/feelpp/metis/archive/refs/tags/v5.3.0-rc.1.tar.gz"
    git = "https://github.com/feelpp/metis.git"
    ...
    version("5.3.1-rc.3", sha256="325866e8d3687be8c487eeaa4b97971d1b3ed708d08af1ed748d46941c11a2ea", preferred=True)
