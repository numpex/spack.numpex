...
class Parmetis(CMakePackage):
    ...
    version("4.0.4-rc.4", sha256="f122838f1ac7e890450b9b98b6afd97f14af1cbb94be20b8630e2a7bd423ad4d",preferred=True)
    version("4.0.4-rc.3", sha256="51d47b659e44a90358f8ca17da6d9ecaecb7be170df58e58fbb4366a85a6c996", deprecated=True)
    version("4.0.4-rc.2", sha256="dec52ed338c1a00202659e01aff0789d4509e0cc318d073015ea2a8a79629256",deprecated=True)
...
#    version("4.0.2", sha256="5acbb700f457d3bda7d4bb944b559d7f21f075bb6fa4c33f42c261019ef2f0b2")
    ...
    variant("omp", default=False, description="Enables OpenMP support")
    depends_on("c", type="build")
    depends_on("cxx", type="build")

    depends_on("cmake@2.8:", type="build")
    depends_on("mpi")
    depends_on("metis@5:", type=("build", "link", "run"))
    depends_on("metis+int64", when="+int64", type=("build", "link", "run"))
    depends_on("metis~int64", when="~int64", type=("build", "link", "run"))
    depends_on("gklib", type=("build", "link", "run"))
    depends_on("metis+real64", when="+real64", type=("build", "link", "run"))
    depends_on("metis~real64", when="~real64", type=("build", "link", "run"))
